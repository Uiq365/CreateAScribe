...
// This class is an activity that houses the functionality for the google sign in.
// it points to the sign in activity layout where there is a google sign in button
